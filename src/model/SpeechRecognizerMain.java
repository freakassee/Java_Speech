...
public class SpeechRecognizerMain {
	...
	public SpeechRecognizerMain() {
		...
		configuration.setAcousticModelPath("src/resources/german_acoustic");
		configuration.setDictionaryPath("src/resources/german_lm/german.dic");
		...
		//====================================================================================
		configuration.setLanguageModelPath("src/resources/german_lm/cmusphinx-voxforge-de.lm.bin");
